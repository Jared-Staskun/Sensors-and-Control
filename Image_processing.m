...
blue_centre = calculate_centroid(extracted_blue);
...
hold on
    ...
    blue_u = num2str(round(blue_centre.Centroid(1)));
    blue_v = num2str(round(blue_centre.Centroid(2)));
    purlpe_info = append(blue_u,", ",blue_v);
    text(blue_centre.Centroid(1) + 10, blue_centre.Centroid(2) + 25, purlpe_info,'FontSize',14,'FontWeight','bold');
